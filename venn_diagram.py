...
inf_bib = infra_bib[
    (infra_bib["Publication_year"] > 2016) & (infra_bib["Publication_year"] < 2023)
]
...
# plt.savefig("Plots/Venn_annualreport.svg", dpi=300)
# plt.savefig("Plots/Venn_annualreport.png", dpi=300)
