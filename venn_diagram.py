...
inf_bib = infra_bib[
    (infra_bib["Publication_year"] > 2017) & (infra_bib["Publication_year"] < 2024)
]

affs_bib = affiliates_bib[
    (affiliates_bib["Publication_year"] > 2017)
    & (affiliates_bib["Publication_year"] < 2024)
]
...
plt.savefig("Plots/Venn_annualreport_2dp.svg", dpi=300)
plt.savefig("Plots/Venn_annualreport_2dp.png", dpi=300)
