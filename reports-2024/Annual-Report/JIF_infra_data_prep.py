...
Pubs_JIF_raw = pd.read_excel(
    "Data/SciLifeLab-publications_Infrastructure_2024.xlsx",
## #    "../unit_stat_half_pagers/Data/infra_2024_comblab.xlsx-ORIG",
...
Pubs_JIF_raw = Pubs_JIF_raw[
    (Pubs_JIF_raw["Year"] > 2018) & (Pubs_JIF_raw["Year"] < 2025)
]
