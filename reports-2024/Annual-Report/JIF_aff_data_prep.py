...
Pubs_JIF_raw = Pubs_JIF_raw[
    (Pubs_JIF_raw["Publication_year"] > 2018)
    & (Pubs_JIF_raw["Publication_year"] < 2025)
]
...
Pubs_JIF_sub.to_excel("jifsub.xlsx")
...
Pubs_JIF_sublow["Journal"] = Pubs_JIF_sublow["Journal"].str.replace(".", "")
